...
namespace Stormpath\Lumen\Http\Traits;
...
//        $cookieJar = app('cookie');
        ...
        return $this->makeAccessTokenCookie($accessToken);
...
//        $cookieJar->queue($cookie);
    ...
    public function makeAccessTokenCookie($accessToken)
    {
        return new Cookie(
            ...
            $accessToken,
            time() + $this->getExpiresTime('accessToken') / 60,
...
//        $cookieJar = app('cookie');
        ...
        return $this->makeRefreshTokenCookie($refreshToken);
...
//        $cookieJar->queue($cookie);
    ...
    public function makeRefreshTokenCookie($refreshToken)
    {
        return new Cookie(
            ...
            $refreshToken,
            time() + $this->getExpiresTime('refreshToken') / 60,
